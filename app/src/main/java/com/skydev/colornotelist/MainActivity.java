...
import com.skydev.colornotelist.Adapters.NotesListAdapter;
import com.skydev.colornotelist.Database.RoomDB;
...
public class MainActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    private void updateRecycler(List<Notes> notes) {
        ...
        recycler_home.setLayoutManager(new StaggeredGridLayoutManager(2, LinearLayout.VERTICAL));
